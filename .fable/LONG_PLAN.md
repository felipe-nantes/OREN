...
| 03 Characterization | IN_PROGRESS (2026-08-17) | safety net legado | waves 1-3 DONE: P0 #1 geometry equality (5 testes; direction-blind, candidata HG-03), P0 #2 nested splits (7 testes; fronteira interna + defaults SCI-003), P0 #3 DICOM phase selection (7 testes; 3 ambiguidades candidatas HG-02); pendente: P0 #4 mask→volumetry |
