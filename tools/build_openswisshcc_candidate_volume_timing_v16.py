...
from dtwin.benchmark.openswisshcc_candidate_volume_timing_bundle import build_candidate_volume_timing_gallery
from dtwin.core import PipelineError


def main() -> int:
    parser = argparse.ArgumentParser(description="Gera a galeria v16 dos quatro casos criticos do piloto temporal.")
    ...
    try:
        result = build_candidate_volume_timing_gallery(
