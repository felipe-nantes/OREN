#!/usr/bin/env python3
"""Freeze or evaluate the nested v26 bounding-box-fill hypothesis."""
...
from dtwin.benchmark.openswisshcc_v26_bbox_fill import (
...
def main() -> int:
    ...
    try:
        if args.command == "freeze":
            result = freeze_v26_bbox_fill_protocol(
