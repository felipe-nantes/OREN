#!/usr/bin/env python3
"""Freeze or evaluate the nested v25 inverse-sphericity hypothesis."""
...
from dtwin.benchmark.openswisshcc_v25_sphericity import (
...
def main() -> int:
    ...
    try:
        if args.command == "freeze":
            result = freeze_v25_sphericity_protocol(
            ...
            result = evaluate_v25_sphericity(
