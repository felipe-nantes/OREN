"""Generate and evaluate multiclass-supervised nested OOF MedSigLIP predictions."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--multiclass-config",
        type=Path,
        default=Path("configs/training/medsiglip_multiclass_v1.yaml"),
    )
    parser.add_argument(
        "--training-config",
        type=Path,
    ...
    parser.add_argument(
        "--predictions",
        type=Path,
        default=Path("casos/qualification/hybrid_v1/medsiglip_multiclass_oof_predictions_v1"),
    )
    parser.add_argument(
        "--evaluation",
        type=Path,
