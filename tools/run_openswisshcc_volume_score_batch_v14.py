...
from dtwin.benchmark.openswisshcc_volume_score import run_volume_score_blind_batch
from dtwin.core import PipelineError


def main(argv=None) -> int:
    parser = argparse.ArgumentParser(description="Executa o batch cego e resumível v14.")
    ...
    try:
        result = run_volume_score_blind_batch(
